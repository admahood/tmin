...
1. File List:
   ...
   A. Filename: fired_na_2017-.gpkg
   B. Filename: fired_sa_2017-.gpkg
...
2. Number of cases/rows: 
    a. fired_na_2017-.gpkg: 132,434
    b. fired_sa_2017-.gpkg: 409,875
...
4. Variable List:
  ...
  B. Name: first_date_7
 	   Description: The first date that the polygon burned minus 7 days

	C. Name: last_date_7
	   Description: The last date that the polygon burned plus 7 days

	D. Name: is_na (for fired_na_2017-.gpkg)
	   Description: 1 = yes, it's in North America, 0 = no
	   
 	D. Name: is_sa (for fired_sa_2017-.gpkg)
     Description: 1 = yes, it's in South America, 0 = no
     
  E. Name: geom
     Description: geometry column (each entry is a coordinate list)